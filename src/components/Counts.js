...
<section id="counts" className="counts">
    <div className="container">
        ...
        <div className="row">
            <div className="col-12 col-xl-12 d-flex align-items-stretch pt-4 pt-xl-0 mx-auto" data-aos="fade-left" data-aos-delay="300">
...
{/* AFBEELDING */}
                            {/* <div className="image col-xl-7 d-flex align-items-stretch justify-content-center justify-content-xl-start" data-aos="fade-right" data-aos-delay="150" data-aos-offset="30">
