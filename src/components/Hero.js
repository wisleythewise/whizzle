...
import ShoppingBagAnimation from './lotties/ShoppingBagAnimation';
import DiscountTagAnimation from './lotties/DiscountTagAnimation';
    ...
    <div className="container">
      <div className="row">
        <div className="col-lg-6 pt-5 pt-lg-0 order-2 order-lg-1 d-flex flex-column justify-content-center">
          <h1 data-aos="fade-up">Stop met zoeken naar deals, laat <span className="gradient-text-animated">Whizzle</span> het werk voor je doen!</h1>
